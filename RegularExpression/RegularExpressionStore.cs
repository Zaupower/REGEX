...
namespace RegularExpression
{
    public static class RegularExpressionStore
    {
        ...
        {
            //New method
            //((?<=\||\;|\\|\,)(068|067|095)\d{8}|(?<=\||\;|\\|\,)\+38(068|067|095)\d{7}|(?<=\||\;|\\|\,)\(?(068|067|095)\)?[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}|(?<=\||\;|\\|\,)\(?(068|067|095)\)?[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3}|^\(?(095|068|067)\)?[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}|^\+38(095|068|067)[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}|^\(?(^095|^068|^067)\)?[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3}|^\+38(095|068|067)[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3})
            //Old Regex _test2Regex = new Regex(@"(\+38\s?(095|067|068)\s?\d{3}(\s?\d{2}){2})|(\(?095\)?\d{3}\d{2}\d{2}|\(?067\)?([\s.-]{0,3})?\d{3}([\s.-]{0,3})?\d{2}([\s.-]{0,3})?\d{2}(?!\d)|\(?068\)?\s\d{4}\s\d{3}(?<=[|,\s;-])*)");
            //Regex _test2Regex = new Regex(@"((?<=\||\;|\\|\,)(068|067|095)\d{8}|(?<=\||\;|\\|\,)\+38(068|067|095)\d{7}|(?<=\||\;|\\|\,)\(?(068|067|095)\)?[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}|(?<=\||\;|\\|\,)\(?(068|067|095)\)?[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3}|^\(?(095|068|067)\)?[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}|^\+38(095|068|067)[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}|^\(?(^095|^068|^067)\)?[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3}|^\+38(095|068|067)[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3})");
            Regex _test2Regex = new Regex(@"((?<=\||\;|\\|\,)(068|067|095)\d{3}\d{2}\d{2}(?!\d)|(?<=\||\;|\\|\,)\+38(068|067|095)\d{3}\d{2}\d{2}(?!\d)|(?<=\||\;|\\|\,)\(?(068|067|095)\)?[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}(?!\d)|(?<=\||\;|\\|\,)\(?(068|067|095)\)?[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3}(?!\d)|^\(?(095|068|067)\)?[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}|^\+38(095|068|067)[\.\s\-]{0,3}?\d{3}[\.\s\-]{0,3}?\d{2}[\.\s\-]{0,3}?\d{2}|^\(?(^095|^068|^067)\)?[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3}|^\+38(095|068|067)[\.\s\-]{0,3}?\d{4}[\.\s\-]{0,3}?\d{3})");
